...
---
<style>
h2 {border-bottom: 1px solid #c9c9c9;}
...
If you're a business person and want to stay focused on the non-technical side of things, meaning you aren't actually going to be building these platforms yourself, then you will benefit most from the materials listed under <strong>Everybody</strong> below. 

At some point in the future, I'll add additional resources for kids.

<strong>Engineers</strong> are often tempted to focus on technology at the expense of the business and societal impact, but AI is different. It will have such a profound influence on every area of our lives that, I believe, anyone building AI systems has a responsibility to understand as much as possible about the big picture.
...
#### Superintelligence
Author: Nick Bostrom [Link on Amazon](http://www.amazon.com/Superintelligence-Dangers-Strategies-Nick-Bostrom-ebook/dp/B00LOOCGB2/ref=tmm_kin_swatch_0?_encoding=UTF8&qid=&sr=)
...
Author: Ray Kurzweil [Link on Amazon](http://www.amazon.com/The-Age-Spiritual-Machines-Intelligence-ebook/dp/B002CIY8JW/ref=pd_sim_351_2?ie=UTF8&dpID=41MLadZgJlL&dpSrc=sims&preST=_AC_UL160_SR104%2C160_&refRID=1NEJTK3E46T2ABVQ1ZQF)
...
Author: Ray Kurzweil [Link on Amazon](http://www.amazon.com/Singularity-Near-Humans-Transcend-Biology-ebook/dp/B000QCSA7C/ref=mt_kindle?_encoding=UTF8&me=)
...
Authors: Erik Brynjolfsson, Andrew McAfee [Link on Amazon](http://www.amazon.com/Second-Machine-Age-Prosperity-Technologies-ebook/dp/B00D97HPQI/ref=mt_kindle?_encoding=UTF8&me=)
...
Author: Ben Coppin [Link on Amazon](http://www.amazon.com/Artificial-Intelligence-Illuminated-Ben-Coppin/dp/0763732303)
...
[TechRepublic - Seven AI Books](http://www.techrepublic.com/article/educate-yourself-on-ai-seven-books-to-get-you-started/)
...
[Executive Data Science Courses](https://www.coursera.org/specializations/executive-data-science)
...
[OpenAI](OpenAI) is a non-profit research organization, chaired by Elon Musk (Tesla, SpaceX, PayPal) and Sam Altman (President of Y Combinator). OpenAI has raised over $1B in funding to date and is dedicated to ensuring that AI technology is developed in such a way that supports, instead of threatens, human life and civilized society.

[Nvidia](http://www.nvidia.com/object/tesla-supercomputing-solutions.html) is playing an important role in the data center world with their high-performance hardware and chips, specifically GPUs.

[The Association for the Advancement of Artificial Intelligence](http://www.aaai.org/home.html) is one of the oldest non-profit scientific organizations dedicated to AI research. They hold a number of excellent events and symposiums around the year.

[The Machine Intelligence Research Institute (MIRI)](https://intelligence.org/) is another non-profit scientific society focused on ensuring that AI has a positive impact. Their blog is quite informative.
...
[Coursera Machine Learning Course with Andrew Ng](https://www.coursera.org/learn/machine-learning) - THE Machine Learning course online.

[Data Science and Analytics in Context](https://www.edx.org/xseries/data-science-analytics-context) - a series of three online courses that covers Machine Learning, Algorithms, Big Data, IoT, and statistical thinking.

[Artificial Intelligence for Robotics](https://www.udacity.com/course/cs373) - taught by the leader of Google's autonomous driving team. 

[Neural Networks for Machine Learning](https://www.coursera.org/course/neuralnets) - a great way to dive more into Neural Networks

[Natural Language Processing](https://www.coursera.org/course/nlangp)

[Computational Neuroscience](https://www.coursera.org/course/compneuro) - learning more about the the human brain works will help understand how computers can learn too.
...
[NumPy](http://www.numpy.org/) - the fundamental library for scientific computing. In particular, contains built-in libraries for Linear Algebra.
...
[Link to Amazon](http://www.amazon.com/Artificial-Intelligence-Modern-Approach-Edition/dp/0136042597)
...
[Link to Amazon](http://www.amazon.com/Paradigms-Artificial-Intelligence-Programming-Studies/dp/1558601910)
...
MIT also has a [great list of AI programming books](http://alumni.media.mit.edu/~jorkin/aibooks.html).

Here is another [good list of free AI programming books](http://bigdata-madesimple.com/20-free-books-to-get-started-with-artificial-intelligence/).

### Other Resources

[Neural Networks and Deep Learning](http://neuralnetworksanddeeplearning.com/) - an excellent site in the form of an online book that dives deep into working with Neural Networks.
